...
module.exports = async (deployer, network, [defaultAccount]) => {
  ...
  gameAnime.setProvider(deployer.provider)
  if (network.startsWith('rinkeby')) {
    await deployer.deploy(gameAnime, RINKEBY_VRF_COORDINATOR, RINKEBY_LINKTOKEN, RINKEBY_KEYHASH)
    let dnd = await gameAnime.deployed()
    ...
    // await deployer.deploy(gameAnime)
    // let dnd = await gameAnime.deployed()
  }
}
